    ...
    <div class="container">
        ...
        <div class="table-responsive">
            <table class="table table-bordered" width="100%" cellspacing="0">
                ...
                <tbody>
                    <?php 
                        $datasql = mysqli_query($connect, "SELECT tb_pelelangan_pemborong.*, 
                        tb_data_peserta_lelang.nik, tb_data_peserta_lelang.nama_peserta 
                        FROM tb_pelelangan_pemborong JOIN tb_data_peserta_lelang 
                        ON tb_pelelangan_pemborong.id_pemborong 
                        = tb_data_peserta_lelang.id 
                        WHERE tb_pelelangan_pemborong.hari_tanggal='$hari_tanggal'");
                        $no = 1;
